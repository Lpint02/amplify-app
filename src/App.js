    ...
    <div className="App">
      ...
      >
        {file ? (
          ...
          <p style={{ fontSize: '18px'}}>Trascina qui il tuo file di input. Per maggiori informazioni clicca qui<button onClick={togglePopup} style={{ cursor: 'pointer', background: 'none', border: 'none', padding: 0, boxShadow: 'none' }}>
